# QuantitativeTrading_CCXT --- 用ccxt实现的量化脚本
## 项目介绍
使用python/ccxt开发的简单脚本，目前实现了网格策略、追踪策略，均为短线高频交易策略。  
bybit交易所开发较为完善，其他交易所代码版本较为落后。k线分析代码需整理。  
可以前往[CSDN-使用CCXT从零开始量化交易](https://blog.csdn.net/qq_27117741/article/details/149136474)快速熟悉此项目是如何进行开发的  
### 请在项目源码基础上做出修改后使用！！！本项目策略并不成熟，直接使用会造成亏损
